...
$installdefs = array (
  ...
  'beans' => 
    ...
    'copy' => array (
        ...
        93 => array (
            'from' => '<basepath>/images/ReminderandNotification.png',
            'to' => 'themes/SuiteR/images/ReminderandNotification.png',
        ),
        94 => array (
            'from' => '<basepath>/images/ReminderandNotification.svg',
            'to' => 'themes/SuiteR/images/ReminderandNotification.svg',
        ),
        95 => array (
            'from' => '<basepath>/images/ReminderandNotification.png',
            'to' => 'themes/Suite7/images/ReminderandNotification.png',
        ),
        96 => array (
            'from' => '<basepath>/images/ReminderandNotification.svg',
            'to' => 'themes/Suite7/images/ReminderandNotification.svg',
        ),
        97 => array (
            'from' => '<basepath>/custom/modules/Administration/css/VIRemindersAndNotificationEditViewSuiteR7.css',
            'to' => 'custom/modules/Administration/css/VIRemindersAndNotificationEditViewSuiteR7.css',
        ),
        98 => array (
            'from' => '<basepath>/custom/modules/Administration/css/VIRemindersAndNotificationListViewSuiteR7.css',
            'to' => 'custom/modules/Administration/css/VIRemindersAndNotificationListViewSuiteR7.css',
        ),
    ),
);
?>