<?php
 /*********************************************************************************
 * This file is part of package Quick View.
 * 
 * Author : Variance InfoTech PVT LTD (http://www.varianceinfotech.com)
 * All rights (c) 2020 by Variance InfoTech PVT LTD
 *
 * This Version of Quick View is licensed software and may only be used in 
 ...
 * 
 ********************************************************************************/
if(!class_exists('VIReminderAndNotificationOutfittersLicense')) {
    class VIReminderAndNotificationOutfittersLicense {
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = VIReminderAndNotificationOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate() {
            ...
            $validated = VIReminderAndNotificationOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('VIReminderAndNotificationOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('VIReminderAndNotificationOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = VIReminderAndNotificationOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private static function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = VIReminderAndNotificationOutfittersLicense::getKey($module);
