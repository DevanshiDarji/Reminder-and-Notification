...
function getProductNameFieldHtml($productAllCondition, $productAnyCondition, $lineCount, $aowField){
    ...
    $getProductNameFieldHtml .= '<button type="button" name="" id="productRemoveButton" tabindex="0" class="button lastChild " onclick="SUGAR.clearRelateField(this.form,'."'".$productName."'".','."'".$productId."'".'); removeProductConditionField(this);" value=""><span class="suitepicon suitepicon-action-clear"></span></button>
    </span>'; 
