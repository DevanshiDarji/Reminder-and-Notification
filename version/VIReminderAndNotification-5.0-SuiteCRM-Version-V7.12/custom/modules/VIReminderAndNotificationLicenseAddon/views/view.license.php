...
class ViewLicense extends SugarView{
    ...
    public function display(){
        ...
        require_once('modules/'.$currentModule.'/license/VIReminderAndNotificationOutfittersLicense.php');
        ...
        $key = VIReminderAndNotificationOutfittersLicense::getKey($currentModule);
        if(!empty($key)) {
        ...
        $this->ss->display('modules/VIReminderAndNotificationLicenseAddon/tpls/license.tpl');
    }//end of display
